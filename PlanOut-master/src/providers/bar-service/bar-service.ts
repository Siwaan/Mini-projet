...
listeBar() : Observable<any>{
  return this.http.get('http://siwandaoud.fr/projetTut/httpGet/nearbySearch.php')
...
choixDetailBar() : Observable<any>{
  return this.http.get('http://siwandaoud.fr/projetTut/httpGet/ChoixDetailBar.php?place_id='+ this.idPlace);
}
}
